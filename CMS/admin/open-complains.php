...
$query=mysqli_query($con,"delete from tblcomplains where Status is null and ID='$cid'");
if($query){
echo "<script>alert('Complaint Record  deleted successfully.');</script>";
echo "<script type='text/javascript'> document.location = 'open-complains.php'; </script>";
} else {
...
<?php endif;?>
 ...
 <a href="open-complains.php?action=delete&&cid=<?php echo $row['ID']; ?>"  title="Delete this record" onclick="return confirm('Do you really want to delete this record?');" class="btn btn-danger">Delete </a>
                                  </td>
                </tr>
                <?php 
$cnt=$cnt+1;
