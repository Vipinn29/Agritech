...
$pagedes=addslashes($_POST['pagedes']);
...
?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <textarea class=" form-control" id="pagedes" name="pagedes" type="text" required="true" value="" rows="15"><?php  echo $row['PageDescription'];?></textarea>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="form-group row">
