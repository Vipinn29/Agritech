...
<?php endif;?>
               ...
               <a href="intransit.php?action=delete&&cid=<?php echo $row['ID']; ?>"  title="Delete this record" onclick="return confirm('Do you really want to delete this record?');" class="btn btn-danger">Delete </a>                      
